...
GlorifiedScrambler = GlorifiedScrambler or {
    config = {},

    IDENTIFIER = "GlorifiedScrambler",
    NICE_NAME = "GlorifiedScrambler"
}
...
frile.includeFolder( "GlorifiedScrambler/", false, true )
frile.includeFolder( "GlorifiedScrambler/modules/" )